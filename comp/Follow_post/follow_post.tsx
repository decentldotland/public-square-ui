...
export default function Follow({ id, user, body, notification = false, className}: FollowProps){
    return (
        <div className={styles.notification_containers  + " " + (notification ? styles.plus_margin : "") + " " + (className || "")}>
